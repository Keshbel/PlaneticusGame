...
namespace ShadowedSouls.Core
{
    public class ChatManager : NetworkBehaviour 
    {
        ...
        private void Start()
        {
            ...
            myName = GetComponent<CurrentPlayer>().playerName;
            print(myName);
        }
        ...
        private void ShowIntro()
        {
            ...
            AddMessage("SYSTEM", "Welcome! The game has begun!", NetworkClient.connection.identity, 2);
        }

        public void ClientConnect()
        {
            NetworkClient.RegisterPrefab(chatMessagePrefab);
        }
        ...
        private void AddMessage(string whoFrom, string message, NetworkIdentity identity, int ignoreLocal = 0)
        {
            ...
            if (NetworkClient.connection.identity.GetComponent<ChatManager>().showTimestamps)
